...
from chikoo.helpers import Track
...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("chikoo/helpers/Raleway-Bold.ttf", 30)
        self.font2 = ImageFont.truetype("chikoo/helpers/Inter-Light.ttf", 30)
